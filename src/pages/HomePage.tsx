...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-gray-900">
      {/* Hero */}
      <div className="relative overflow-hidden bg-gradient-to-br from-white via-blue-50 to-indigo-50 border-b border-slate-200">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
          <div className="inline-flex items-center gap-2 bg-blue-100 border border-blue-200 rounded-full px-4 py-2 text-blue-600 text-sm mb-8">
          ...
          <p className="text-sm text-slate-400">最后更新：{lastUpdated} · 点击论文标题查看中文洞察分析 ✨</p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        <h2 className="text-2xl font-bold text-center mb-3 text-slate-800">选择研究方向</h2>
        <p className="text-slate-400 text-center mb-12">点击论文标题可查看中文摘要、创新点分析、核心公式等洞察内容</p>

        <div className="grid md:grid-cols-3 gap-6">
          {/* Embodied AI */}
          <Link to="/embodied" className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white hover:border-blue-300 hover:shadow-xl hover:shadow-blue-100 transition-all duration-300">
            ...
            <div className="relative p-7">
              ...
              <h3 className="text-xl font-bold mb-2 text-slate-800 group-hover:text-blue-600 transition-colors">具身智能</h3>
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-slate-400">30+ 篇</span>
          ...
          {/* World Model */}
          <Link to="/worldmodel" className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white hover:border-purple-300 hover:shadow-xl hover:shadow-purple-100 transition-all duration-300">
            ...
            <div className="relative p-7">
              ...
              <h3 className="text-xl font-bold mb-2 text-slate-800 group-hover:text-purple-600 transition-colors">世界模型</h3>
              <p className="text-slate-400 mb-5 text-sm leading-relaxed">
          ...
          {/* Infra */}
          <Link to="/infra" className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white hover:border-emerald-300 hover:shadow-xl hover:shadow-emerald-100 transition-all duration-300">
            ...
            <div className="relative p-7">
              ...
              <h3 className="text-xl font-bold mb-2 text-slate-800 group-hover:text-emerald-600 transition-colors">AI 训练 Infra</h3>
              <p className="text-slate-400 mb-5 text-sm leading-relaxed">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-slate-400">25+ 篇</span>
      ...
      <div className="border-t border-slate-200 bg-white">
        <div className="max-w-6xl mx-auto px-6 py-10 text-center">
          <p className="text-slate-400 text-sm mb-4">数据来源</p>
          <div className="flex flex-wrap justify-center gap-3 text-slate-500">
            {['arXiv', 'Papers with Code', 'Google Scholar', 'Semantic Scholar', 'CVPR', 'NeurIPS', 'ICLR', 'OSDI', 'MLSys', 'SC'].map(src => (
              <span key={src} className="text-xs border border-slate-200 bg-slate-50 rounded-full px-3 py-1 hover:bg-slate-100 transition-colors">{src}</span>
            ))}
          </div>
        </div>
      </div>
